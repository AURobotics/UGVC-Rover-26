...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\road_detector\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\road_detector\hook\ament_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\..\..\build\road_detector\share\road_detector\hook\pythonpath_develop.bat"
