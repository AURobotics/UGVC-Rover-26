...
class UsbCameraPublisher(Node):
    def __init__(self):
        ...
        # Parameters
        self.declare_parameter('device_index', 4)       # /dev/video0
        ...
        # QoS - Best effort is often preferred for raw image streaming to save bandwidth, 
        # but keeping RELIABLE as per your original configuration.
        ...
        self.pub = self.create_publisher(Image, topic, qos_profile)
    ...
    def timer_cb(self):
        ...
        if ret and frame is not None:
            try:
                # Convert the OpenCV BGR frame directly to a ROS 2 Image message
