...
class ObstacleDetector(Node):
    ...
    def __init__(self):
        ...
        # publishers
        self.camera_publisher = self.create_publisher(Image,Camera_test,qos_profile)
    ...
    def camera_callback(self, msg):
        ...
        if hasattr(RoadFeatureDetector,"draw_circles"):
            frame = RoadFeatureDetector.draw_circles(circles,frame)
        ...
        self.publish_image(self.camera_publisher, frame)
    ...
    def publish_image(self, publisher, frame):
        if frame is None:
            self.get_logger().warn("Attempted to publish an empty frame.")
            return
        try:
